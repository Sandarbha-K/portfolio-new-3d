...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_8ql5a6b', 'template_pp9nzp4', form.current, 'fxWYK7aDVksszP5aa')
        .then((result) => {
    ...
    <div className="mb-20" id="contact" >
      <div className="md:w-10/12 w-11/12 mx-auto ">
        ...
        <div className="md:w-8/12 w-full mx-auto">
            ...
            <p className='text-xl text-neutral-200 mb-5'>My Email: <span className='italic text-sm text-neutral-400'>sandarbha.2002@gmail.com</span></p>
